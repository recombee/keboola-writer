from recombee_api_client.api_requests import AddDetailView, Request
...
class DetailViewsHandlerBase(BaseInteractionsHandler):
    def __init__(
    ...
    def to_request(self, row) -> Request:
        duration_raw = self.safe_get(row, "duration")
        try:
